...
public class CheckersStorage{
	...
	public long updateBoard(long rowIndex, String Name, String Dump, Date SavedDate, Long Width, Long Heigth, Long Score)
	{
	...
	public Cursor getBoard(long rowIndex)
	{
		Cursor res = mDb.query(BOARD_TABLE, new String[] {
					...
					BOARD_WIDTH_KEY,
					BOARD_HEIGTH_KEY,
					BOARD_SCORE_KEY}, BOARD_ROW_ID + " = " + rowIndex, null, null, null, null);
		if(res != null){
			res.moveToFirst();
		}
		return res;
	...
	// -------------- BOARDSCORE HELPERS ------------------
	public long addBoardScore(String Name, Long MaxScore)
	{
		ContentValues contentValues = new ContentValues();
	...
	public long updateBoardScore(long rowIndex, String Name, Long MaxScore)
	{
	...
	public Cursor getBoardScore(long rowIndex)
	{
		Cursor res = mDb.query(BOARDSCORE_TABLE, new String[] {
					BOARDSCORE_ROW_ID,
					BOARDSCORE_NAME_KEY,
					BOARDSCORE_MAXSCORE_KEY}, BOARDSCORE_ROW_ID + " = " + rowIndex, null, null, null, null);
		if(res != null){
			res.moveToFirst();
		}
		return res;
